...
enum DifficultyLevel: String, CaseIterable, Identifiable {
    ...
    var localizedName: String {
        ...
        case .level7: return "difficulty.level7".localized
        }
    }
    ...
    var range: ClosedRange<Int> {
        ...
        case .level5: return 1...50      // 50以内乘除法 (changed from 1...20)
        case .level6: return 1...1000    // 1000以内混合运算 (changed from 1...100)
        case .level7: return 1...100     // 100以内含分数混合运算 (NEW)
        }
    }
    ...
    var questionCount: Int {
        ...
        case .level5: return 30          // Changed from 25 to 30
        case .level6: return 100         // No change
        case .level7: return 100         // NEW
        }
    }
    ...
    var pointsPerQuestion: Int {
        ...
        case .level5: return 3  // 30题 × 3分 = 90分 (with 10 bonus for perfect)
        case .level6: return 1  // 100题 × 1分 = 100分
        case .level7: return 1  // 100题 × 1分 = 100分
        }
    }
